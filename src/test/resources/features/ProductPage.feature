...
#    Then User should see increase contain button disabled
  ...
  Scenario: Increase cart contain quantity
    ...
    Then User should see contain quantity increase
    And User should see cart price increase
  ...
  Scenario: Decrease cart contain quantity
    ...
    Then User should see contain quantity reduce
    And User should see cart price decrease
